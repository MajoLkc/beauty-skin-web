...
export const Services: React.FC = () => (
  <ContentWrapper>
    ...
    <SmallTitle text="Esthermax" id="esthermax" />
    <Paragraph text="Kozmetika značky ESTHEMAX je prémiovej kvality v starostlivosti o pleť. Známa je po celom svete a aktuálne už aj na slovenskom trhu." />
    <Paragraph text="Spoločnosť ESTHEMAX spojila účinky hydrogelových masiek s blahodarnými účinkami elektrolytov. Elektrolyty sú minerály, ako napr. vápnik, sodík, draslík, horčík či fosfor a ich úlohou je udržiavať v bunkách správne množstvo vody, ktoré je nevyhnutné pre ich fungovanie. Základnou zložkou Hydrojelly masky sú okrem elektrolytov predovšetkým  morské riasy, ktoré obsahujú veľmi veľa minerálov a vitamínov, ďalej je to organický prášok z bielej vŕby, z celozrnnej a bielej ryže a posledná zložka je organický prášok z ovsa. Jednou z bežných príčin suchej pokožky je práve nerovnováha elektrolytov. Pokožka tím nedokáže absorbovať a zadržiavať správne množstvo vody, ktorá je nevyhnutná pre zdravie a krásnu pleti. Preto ak zmiešame Hydrogelovú elektrolytickú masku s vodou vznikne nám silná hydratačná infúziu pre našu pleť. Toto je nová generácia zlupovacích masiek, ktoré dodajú vašej pleti nie len potrebnú hydratáciu, ale vďaka pridaným organickým zložkám budem vaša pleť žiarivá, vypnutá, plná vitamínov a bez rôznych nedostatkov. Zloženie neobsahuje parabény, sulfáty, ftaláty, škrob ani mastenec. Netestované na zvieratách, biologicky rozložiteľný odpad." />
    <SmallTitle
      text="Biomicroneedling - prírodná revolúcia v starostlivosti o pleť"
      id="biomicroneedling"
    />
